...
public class AbheeTaskDao {
	...
	public List<Map<String,Object>> getTasksListAssignToMe()
	{
		 ...
		 sql="select t.id,t.assignto,u.username,t.uploadfile,t.category as categoryid,s.servicetypename,t.created_time,t.description,t.kstatus,ts.name as statusname,t.priority as priorityid,p.priority,t.severity as severityid,t.service_type as servicetypeid,sev.severity, "
				 + "t.status,t.subject,t.taskdeadline,t.invimg,t.taskno,t.modelid,ab.category,abp.name as modelname,t.customer_id, t.communicationaddress,t.amountreceived,t.discount,t.tax,t.total,ar.requesttime,t.modelid,t.warranty,t.add_comment "
			...
			else
			{
				sql="select t.id,t.assignto,u.username,t.category as categoryid,s.servicetypename,t.created_time,t.description,t.kstatus,ts.name as statusname,t.priority as priorityid,p.priority,t.invimg,t.severity as severityid,sev.severity, "
						 + "t.status,t.subject,t.taskdeadline,t.taskno,t.invimg,t.modelid,ab.category,abp.name as modelname,t.customer_id , t.communicationaddress,t.amountreceived,t.discount,t.tax,t.total,ar.requesttime,t.warranty,t.add_comment "
						+" FROM abhee_task t,abheeusers u,abheeservicetype s,abheetaskstatus ts,abheepriority p,abheeseverity sev,abheecategory ab ,abhee_product abp,abheerequesttime ar"
