		...
		public List<Map<String, Object>> getSalesRequestList1(SalesRequest salesRequest)
		 {
			...
			/* String hql ="select sr.request_type,sr.salesrequestnumber,ap.name as modelname from abhee_sales_request sr,abhee_product ap where sr.customerid='"+salesRequest.getCustomerid()+"' and sr.modelnumber=ap.id";*/
		...
		public List<Map<String, Object>> getSalesRequestListByCustomerId(String custId)
		 {
			 ...
			 String hql ="select sr.salesrequestnumber,ap.name as modelname,sr.address,sr.reqdesc,sr.imgfiles from abhee_sales_request sr,abhee_product ap where sr.modelnumber=ap.id and sr.customerid='"+custId+"'";
			 System.out.println(hql);
		...
		public List<Map<String, Object>> getSalesRequestListByRequestNo(SalesRequest req)
		 {
			 ...
			 /*String hql ="select sr.id,sr.address,sr.email,sr.created_time,sr.imgfiles,sr.location,ap.name as modelname,sr.comments,sr.customerid,sr.mobileno,sr.reqdesc,sr.salesrequestnumber,sr.quotation_documents,sr.enable,sr.customername,sr.request_type\n" + 
			 		"from abhee_sales_request sr, abhee_product ap where sr.modelnumber=ap.id and salesrequestnumber='"+req.getSalesrequestnumber()+"'";*/
